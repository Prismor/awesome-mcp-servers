...
- **[Prismix](https://prismix.dev)** - Real-time status monitor for 77 AI APIs (OpenAI, Anthropic, Gemini, Mistral, Cursor, etc.) with an MCP server endpoint exposing current status, incidents, and latency data.
