...
- **[Prismix MCP Directory](https://prismix.dev/mcp)** - Curated directory of 500+ MCP servers with GitHub discovery, per-server release tracking, and bundle collections (group servers into reusable sets).
